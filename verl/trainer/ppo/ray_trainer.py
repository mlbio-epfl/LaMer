...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, step_gamma=0.95, traj_gamma=0.3, lam=1.0, num_repeat=1, multi_turn=False, norm_adv_by_std_in_grpo=True, step_advantage_w=1.0, gigpo_mode="mean_std_norm", **kwargs):
...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            test_output_gen_batch, traj_cot_logs = self.traj_collector.multi_turn_loop(
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        batch = compute_advantage(
                            ...
                            traj_gamma = self.config.algorithm.traj_gamma,
