...
class EpisodeRewardManager:
    ...
    def __init__(self, tokenizer, num_examine, normalize_by_length=False, overlong_buffer_cfg=None) -> None:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in range(len(data)):
            ...
            # add soft overlong penalty
            if self.overlong_buffer_cfg and self.overlong_buffer_cfg.enable:
                overlong_buffer_len = self.overlong_buffer_cfg.len
                expected_len = self.overlong_buffer_cfg.max_resp_len - overlong_buffer_len
